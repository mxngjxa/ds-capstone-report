...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{figures/rnn-vs-lstm.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{figures/transformer_architecture.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{figures/model_pipeline.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{figures/1_url_collection_summary.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{figures/2_label_distribution_all.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{figures/3_label_distribution_no_white.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{figures/5_character_type_distribution.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{figures/7_lda_75topics.png}}

}

\caption{75 topics and T-SNE using \texttt{pca}.}

\end{figure}%

\begin{figure}[H]

{\centering \pandocbounded{\includegraphics[keepaspectratio]{figures/8_lda_150topics.png}}

}

\caption{150 topics and T-SNE using \texttt{pca}.}

\end{figure}%

\begin{figure}[H]

{\centering \pandocbounded{\includegraphics[keepaspectratio]{figures/9_1_150.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{figures/9_2_150.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{figures/9_3_150.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{figures/10_simplified_performance_comparison.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{figures/11_accuracy_vs_weighted_f1_zoomed.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{figures/12_precision_vs_recall.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{figures/13_complexity_vs_performance.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{figures/15_v4.6.5_six_model.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{figures/16_v4.6.5_three_model.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{figures/17_v4.5.1_lgbm_search.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{figures/18_v4.5.7_xgboost_randomized_search_results_reduced.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{figures/19_4.5.2_xgboost_underfit.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{figures/20_train_test_macro_custom_weights.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{figures/21_iteration_21_confusion_matrix.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{figures/22_v4_cm_cut.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{figures/22_v4_cm_search.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{figures/23_v4.4.0_cm.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{figures/24_v4.4.3_holdout_cm.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{figures/25_v5_confusion_matrix.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{figures/26_v5_per_class_metrics_train_test.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{figures/27_v4.6.3_cm_comparison.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{figures/28_v4.9.1_combined_comparison_f1-score.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{figures/29_v4.9.2_combined_comparison_f1-score.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{figures/29_v4.9.2_comparison_performance_summary.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{figures/29_v4.9.2_test_cm_comparison.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{figures/hinge_loss.png}}

}

\caption{Hinge Loss in SVM}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{figures/30_4.9.4-svm.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{figures/30_4.9.4-xgb.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{figures/31_4.9.4-3_metrics_plotted.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{figures/32_4.9.4-dataset-size-by-category.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{figures/33_4.9.4-f1-score-with-regression-line.png}}
